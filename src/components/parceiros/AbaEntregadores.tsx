...
import { Bike, Car, CircleDot, Power, PowerOff, Trash2 } from "lucide-react";
...
export function AbaEntregadores({ entregadores, clientes, onToggleOnline, onExcluir }: AbaEntregadoresProps) {
